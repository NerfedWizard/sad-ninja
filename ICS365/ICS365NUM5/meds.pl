...
no_interacts(X):- interacts(W,V,Z),nl, print(W),nl,print(V),false.  
	

effect(Z) :- interacts(X,Y,Z),nl,
 print(X),nl,print(Y),nl,false.

interaction(X) :- interacts(X,Y,Z),nl,print(Y),nl,print(Z),nl,false.

have_interaction(X,Y) :- interacts(X,Y,Z),nl,not(print(Z)),false.
